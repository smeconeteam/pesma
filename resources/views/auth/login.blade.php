        ...
        <section class="rounded-2xl border border-gray-100 bg-white p-6 shadow-lg sm:p-8 dark:border-gray-700 dark:bg-gray-800">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="email" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" />
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" class="w-full rounded-lg border-gray-300 pr-10 focus:border-green-500 focus:ring-green-500 dark:border-gray-600 dark:bg-gray-900 dark:text-white" type="password" name="password" required autocomplete="current-password" />
                        ...
                        <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                            ...
                            <svg id="eye-slash-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hidden h-5 w-5">
                ...
                <div class="block">
                    <label for="remember_me" class="inline-flex cursor-pointer items-center">
                        <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-green-600 shadow-sm focus:ring-green-500 dark:border-gray-600 dark:bg-gray-800" name="remember">
                ...
                <div class="flex flex-col gap-4 pt-2">
                    ...
                    <p class="text-center text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a href="{{ url('/pendaftaran') }}" class="font-bold text-green-700 underline decoration-2 underline-offset-2 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-xs text-gray-400 dark:text-gray-500">atau</span>
                        <div class="h-px flex-1 bg-gray-200 dark:bg-gray-700"></div>
                    </div>

                    <a href="{{ url('/admin/login') }}" class="w-full rounded-xl bg-gray-100 px-4 py-3 text-center font-bold text-green-600 ring-1 ring-inset ring-green-600 transition-colors hover:bg-green-600 hover:text-white dark:bg-gray-800 dark:text-green-400 dark:ring-green-500 dark:hover:bg-green-600 dark:hover:text-white"">
                        Login sebagai Admin
                    </a>
                </div>
            </form>
