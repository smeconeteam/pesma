    ...
    <div class="py-4 sm:py-10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4 sm:space-y-6">
            ...
            @else
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4 sm:p-6">
                        <div class="text-sm sm:text-base font-semibold text-gray-900 mb-3 sm:mb-4">Profil PIC</div>
                        ...
                        <div class="p-3 sm:p-4 rounded-lg border border-gray-200 bg-gray-50">
                            <div class="flex items-start gap-3">
                                <div class="shrink-0">
                                    @if ($picPhotoUrl)
                                        <img src="{{ $picPhotoUrl }}" alt="Foto PIC"
                                             class="h-10 w-10 sm:h-12 sm:w-12 rounded-full object-cover border-2 border-white shadow-sm" />
                                    @else
                                        <div class="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-gray-200 border-2 border-white shadow-sm flex items-center justify-center">
                                            <span class="text-sm sm:text-base font-semibold text-gray-600">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="font-semibold text-sm sm:text-base text-gray-900">
                                        {{ $picName }}
                                        @if ($isYouPic)
                                            <span class="ml-1 sm:ml-2 inline-flex items-center px-1.5 sm:px-2 py-0.5 rounded-full text-xs font-semibold bg-green-50 text-green-700 border border-green-200">
                                                Kamu
                                            </span>
                                        @endif
                                    </div>

                                    @if (!empty($picPhoneNumber))
                                        <div class="mt-1 flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-gray-600">
                                            ...
                                            <span class="font-medium">{{ $picPhoneNumber }}</span>
                                        </div>
                                    @endif
                            ...
                            {{-- Tombol WhatsApp PIC --}}
                            @if ($picName !== '-' && !empty($picPhoneNumber) && !$isYouPic)
                                @php
                                ...
                                <div class="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200">
                                    <a href="https://wa.me/{{ $cleanPicPhone }}" 
                                       target="_blank"
                                       class="inline-flex items-center justify-center gap-2 w-full px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-green-500 to-green-600 rounded-lg font-semibold text-xs sm:text-sm text-white hover:from-green-600 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all shadow-sm hover:shadow-md active:scale-95">
