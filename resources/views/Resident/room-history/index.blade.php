                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
                        <div class="flex items-start justify-between">
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900">{{ $residentProfile->full_name }}</h3>
                            ...
                            @else
                                <div class="flex h-20 w-20 items-center justify-center rounded-lg bg-gray-200 text-2xl font-bold text-gray-600">
                    ...
                    @if($currentRoom)
                        <div class="mb-6 rounded-lg border-2 border-green-500 bg-green-50 p-4">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h4 class="text-sm font-medium text-green-800">Kamar Saat Ini</h4>
                    ...
                    @else
                        <div class="mb-6 rounded-lg border border-gray-300 bg-gray-50 p-4">
                            <p class="text-center text-sm text-gray-600">Belum ada penempatan kamar saat ini</p>
                        </div>
                    @endif

                    {{-- Riwayat Perpindahan --}}
                    <div class="mb-4">
                        <h4 class="text-lg font-semibold text-gray-900">Riwayat Perpindahan</h4>
                        <p class="text-sm text-gray-600">Total {{ $histories->count() }} riwayat perpindahan</p>
                    </div>
                    ...
                    @if($histories->isEmpty())
                        <div class="rounded-lg border border-gray-200 bg-gray-50 p-8 text-center">
                            ...
                            <p class="mt-2 text-sm text-gray-600">Belum ada riwayat perpindahan kamar</p>
                        </div>
                    @else
                        {{-- Timeline View --}}
                        <div class="relative">
                                ...
                                <div class="mb-8 flex">
                                    ...
                                    <div class="flex-1 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            @if($history->notes)
                                                <div class="mt-3 rounded bg-gray-50 p-2">
                                                    <p class="text-xs text-gray-600">Catatan:</p>
                                                    <p class="text-sm text-gray-800">{{ $history->notes }}</p>
                                                </div>
                                            @endif
                        ...
                        <div class="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div class="rounded-lg border border-gray-200 bg-white p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm text-gray-600">Total Kamar Dihuni</p>
                                        <p class="text-2xl font-semibold text-gray-900">{{ $histories->count() }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="rounded-lg border border-gray-200 bg-white p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm text-gray-600">Perpindahan Kamar</p>
                                        <p class="text-2xl font-semibold text-gray-900">{{ $histories->where('movement_type', 'transfer')->count() }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="rounded-lg border border-gray-200 bg-white p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm text-gray-600">Sebagai PIC</p>
                                        <p class="text-2xl font-semibold text-gray-900">{{ $histories->where('is_pic', true)->count() }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
