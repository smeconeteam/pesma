                ...
                <div class="p-4 sm:p-6">
                    ...
                    <div class="mb-4 sm:mb-6 rounded-lg border-2 border-green-500 bg-green-50 p-3 sm:p-4">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                            <div class="flex-1">
                                <h4 class="text-xs sm:text-sm font-medium text-green-800">{{ __('roomhistory.current_room') }}</h4>
                    ...
                    <div class="mb-4 sm:mb-6 rounded-lg border border-gray-300 bg-gray-50 p-3 sm:p-4">
                        <p class="text-center text-xs sm:text-sm text-gray-600">{{ __('roomhistory.no_current_room') }}</p>
                    </div>
                    @endif
                    ...
                    <div class="mb-6 sm:mb-8 grid grid-cols-1 gap-3 sm:gap-4 md:grid-cols-3">
                        <div class="rounded-lg border border-gray-200 bg-white p-3 sm:p-4 shadow-sm">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs sm:text-sm text-gray-600">{{ __('roomhistory.total_rooms') }}</p>
                        ...
                        <div class="rounded-lg border border-gray-200 bg-white p-3 sm:p-4 shadow-sm">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs sm:text-sm text-gray-600">{{ __('roomhistory.room_transfers') }}</p>
                        ...
                        <div class="rounded-lg border border-gray-200 bg-white p-3 sm:p-4 shadow-sm">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs sm:text-sm text-gray-600">{{ __('roomhistory.times_as_pic') }}</p>
                    ...
                    <div class="mb-3 sm:mb-4">
                        <h4 class="text-base sm:text-lg font-semibold text-gray-900">{{ __('roomhistory.history_title') }}</h4>
                        <p class="text-xs sm:text-sm text-gray-600">{{ __('roomhistory.total_history', ['count' => $histories->count()]) }}</p>
                    </div>
                    ...
                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-6 sm:p-8 text-center">
                        ...
                        <p class="mt-2 text-xs sm:text-sm text-gray-600">{{ __('roomhistory.no_history') }}</p>
                    </div>
                    @else
                    {{-- Timeline View --}}
                    <div class="relative">
                            ...
                            <div class="flex-1 rounded-lg border border-gray-200 bg-white p-3 sm:p-4 shadow-sm">
                                ...
                                <div class="mt-2 sm:mt-3">
                                    ...
                                    <div class="mt-2 grid grid-cols-2 gap-3 sm:gap-4 text-xs sm:text-sm">
                                        <div>
                                            <span class="text-gray-600">{{ __('roomhistory.check_in') }}:</span>
                                            <p class="font-medium text-gray-900">
                                                {{ \Carbon\Carbon::parse($history->check_in_date)->format('d M Y') }}
                                            </p>
                                        </div>
                                        <div>
                                            <span class="text-gray-600">{{ __('roomhistory.check_out') }}:</span>
                                            <p class="font-medium text-gray-900">
                                    ...
                                    @endphp
                                    <div class="mt-2">
                                        <span class="text-xs text-gray-600">{{ __('roomhistory.duration') }}:</span>
                                    ...
                                    <div class="mt-2 sm:mt-3 rounded bg-gray-50 p-2">
                                        <p class="text-xs text-gray-600">{{ __('roomhistory.notes') }}:</p>
