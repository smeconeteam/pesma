            ...
            @if (!empty($contacts) && count($contacts) > 0)
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl rounded-xl border border-gray-100">
                    <div class="p-5 sm:p-7">
                        ...
                        {{-- Info Note --}}
                        <div class="mt-5 flex items-start gap-2 p-3 bg-green-50 rounded-lg border border-green-100">
                            ...
                            <div class="text-xs text-green-700 leading-relaxed">
                                Klik kontak untuk langsung terhubung ke WhatsApp dengan pesan otomatis.
                            </div>
                        </div>
                    </div>
                </div>
