    ...
    protected function handleRecordCreation(array $data): Model
    {
        return DB::transaction(function () use ($data) {
            ...
            if (($profile['citizenship_status'] ?? 'WNI') === 'WNI') {
                ...
                if ($indoId) $profile['country_id'] = $indoId;
            }
            ...
            // 3) profile (pakai relasi biar user_id otomatis)
            ...
            if (! $roomId) {
                throw ValidationException::withMessages([
                    'room_assignment.room_id' => 'Kamar wajib dipilih.',
                ]);
            }

            if (! in_array($gender, ['M', 'F'], true)) {
                throw ValidationException::withMessages([
                    'residentProfile.gender' => 'Jenis kelamin wajib diisi.',
                ]);
            }
